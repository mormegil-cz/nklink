...
function outputJsonp($result, $params)
{
...
function outputRedirect($result, $params)
{
...
function outputHtml($result, $params)
{
	if (!is_array($result) || !isset($result['links'])) {
		// not found on Wikidata
...
<footer>
<hr />
<p>Generated by NK Link at <?php echo gmdate("Y-m-d H:i:s"); ?>Z. <a href="https://nklink.toolforge.org/">Documentation</a>, <a href="https://github.com/mormegil-cz/nklink/wiki/N%C3%A1vrh-API">API</a>, and <a href="https://github.com/mormegil-cz/nklink/">source code</a> is available.</p>
</footer>
</body>
</html>
<?php
...
function main()
{
	...
	FORMATTERS[$format]($resultData, $params);
}
